...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (bisqwit-minor-mode bisqwit bisqwit-theme bisqwit-mode highlight-chars highlight-numbers parent-mode c++theme-theme kaolin-themes solarized-theme move-text multiple-cursors magit gruber-darker-theme zenburn-theme)))
