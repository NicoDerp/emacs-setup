...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (bisqwit bisqwit-theme bisqwit-mode highlight-chars highlight-numbers parent-mode c++theme-theme kaolin-themes solarized-theme move-text multiple-cursors magit gruber-darker-theme zenburn-theme)))
...
(define-minor-mode bisqwit-minor-mode
  "Minor mode for c++ customization"
  :init-value 1
  :lighter "Bisqwit C++ Mode"
  :group 'bisqwit-group
  (when (bound-and-true-p bisqwit-minor-mode)
    (font-lock-add-keywords nil bisqwit-keywords)
    (font-lock-fontify-buffer))
  (when (not (bound-and-true-p bisqwit-minor-mode))
